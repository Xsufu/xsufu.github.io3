/** Шрифты **/
            ...
            @font-face {
                 ...
                 src: url(http://esdo.ssuwt.ru/theme/font.php/opentechnology/theme_opentechnology/1585138938/OpenSans-Light.ttf) format('truetype');
                 font-weight: 300;
                 font-style: normal;
            }
            @font-face {
                 font-family: 'DefaultFont';
                 src: url(http://esdo.ssuwt.ru/theme/font.php/opentechnology/theme_opentechnology/1585138938/OpenSans-LightItalic.ttf) format('truetype');
                 font-weight: 300;
                 font-style: italic;
            }
            @font-face {
                 font-family: 'DefaultFont';
                 src: url(http://esdo.ssuwt.ru/theme/font.php/opentechnology/theme_opentechnology/1585138938/OpenSans-Regular.ttf) format('truetype');
                 font-weight: 400;
                 font-style: normal;
            }
            @font-face {
                 font-family: 'DefaultFont';
                 src: url(http://esdo.ssuwt.ru/theme/font.php/opentechnology/theme_opentechnology/1585138938/OpenSans-Semibold.ttf) format('truetype');
                 font-weight: 600;
                 font-style: normal;
            }
            @font-face {
                 font-family: 'DefaultFont';
                 src: url(http://esdo.ssuwt.ru/theme/font.php/opentechnology/theme_opentechnology/1585138938/OpenSans-Bold.ttf) format('truetype');
                 font-weight: 700;
                 font-style: normal;
            }
...
.breadcrumb > li > .divider {
    background: url('/theme/image.php/opentechnology/theme/1585138938/delimiter') center center no-repeat;
    background-size: contain;
    padding: 5px;
    margin: 0 5px;
}
.breadcrumb > li:first-child a:before {
    background: url('/theme/image.php/opentechnology/theme/1585138938/home') left center no-repeat;
    content: '';
    display: inline-block;
...
#page-header .headertext_wrapper > div {
    ...
    background-image: url("http://esdo.ssuwt.ru/theme/image.php/opentechnology/theme_opentechnology/1585138938/texture/Cubes");
    overflow: hidden;
    color: #FFFFFF;
}
...
#h_rightblock_wrapper .button_crw:after {
    background-image: url('/theme/image.php/opentechnology/theme/1585138938/btn/btn-crw');
    content: '';
}
#h_rightblock_wrapper .button_portfolio:after {
    background-image: url('/theme/image.php/opentechnology/theme/1585138938/btn/btn-portfolio');
    content: '';
}
...
.popover-region-notifications .popover-region-header-text:before {
	background: transparent url('/theme/image.php/opentechnology/theme_opentechnology/1585138938/notifications') center center no-repeat;
	background-size: 40px;
}
.popover-region-messages .popover-region-header-text:before {
    background: transparent url('/theme/image.php/opentechnology/theme_opentechnology/1585138938/message') center center no-repeat;
    background-size: 40px;
}
...
#dock_bg .langmenu_wrapper > label {
    ...
    padding: 0;
    margin: 0;
    background-image: url('/theme/image.php/opentechnology/theme/1585138938/lang');
    background-repeat: no-repeat;
    background-position: center center;
...
#dock_bg .langmenu_wrapper select.langmenu {
    ...
    background: #FFF url('/theme/image.php/opentechnology/theme/1585138938/formelement/arrow1');
...
.block_linksocial.block_docked .potentialidp a .oauthicon.onlineedu:hover {
    background-image: url('data:image/png;base64,');
}
...
.block_linksocial.block_docked .potentialidp a .oauthicon.esia:hover {
	background-image: url('data:image/png;base64,');
}
...
.moodle-dialogue-base .closebutton:active {
    ...
    border-radius: 0;
	background-color: transparent;
	background-image:url("/theme/image.php/opentechnology/core/1585138938/t/dockclose");
	background-repeat: no-repeat;
...
#page-wrapper ul.format_opentechnology_sections.format_opentechnology_base > li > .content > .sectionhead h3:before {
    display: inline-block;
    background-image: url(/theme/image.php/opentechnology/format_opentechnology/1585138938/arrow_right);
    background-size: contain;
    background-repeat: no-repeat;
    content: '';
    width: 23px;
...
.user-loginas-panel #page-popup .loginbox {
	border: none;
	width: 365px;
...
.user-loginas-panel #page-popup #maincontent {
	height: 0;
}
#page-popup #page-content {
    margin-bottom: 0;
}
.user-loginas-panel #page-popup .block-region {
	margin: 0;
}
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent.potentialidps h6 {
	margin: 0 0 30px 0;
}
...
.user-loginas-panel #page-popup .loginbox .loginform .form-input {
	width: 100%;
    order: 1;
}
.user-loginas-panel #page-popup .loginbox .loginform .form-input ~ .form-input {
	width: 100%;
    order: 2;
}
...
.user-loginas-panel #page-popup .loginbox .loginform .form-input .form-label {
	width: 100%;
    margin: 0;
}
...
#page-content .loginbox .loginpanel .subcontent.loginsub .rememberpass input[type="checkbox"]:checked:after {
	background: #fff url('/theme/image.php/opentechnology/theme_opentechnology/1585138938/cb_2') 50% 50% no-repeat;
}
#page-content .loginbox .loginpanel .subcontent.loginsub .rememberpass {
	margin-bottom: 40px;
}
.user-loginas-panel #page-popup .loginbox .loginpanel .subcontent.loginsub .rememberpass {
	width: 100%;
    order: 3;
    text-align: left;
    margin-bottom: 30px;
...
.user-loginas-panel #page-popup .loginbox .loginpanel .subcontent.loginsub .loginform-bottom {
	margin-bottom: 30px;
}
.user-loginas-panel #page-popup .loginbox .loginpanel .subcontent.loginsub .loginform-bottom .submit-wrapper,
.user-loginas-panel #page-popup .loginbox .loginpanel .subcontent.loginsub .loginform-bottom .clearer {
	display: none;
}
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent.potentialidps .potentialidplist {
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper {
	display: flex;
	flex-wrap: wrap;
}
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub {
	margin: 0;
	display: flex;
}
...
#page-content .loginbox .desc .helptooltip {
    ...
    width: 23px;
    background-color: #FFFFFF;
    background-image: url('/theme/image.php/opentechnology/theme/1585138938/help_question');
    background-repeat: no-repeat;
    background-position: 0 0;
    margin-left: 10px;
    filter: brightness(1) invert(0%);
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon:hover + .desc,
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon + .desc:hover {
	bottom: 35px;
	top: unset;
}
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon:hover + .desc:before,
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon + .desc:hover:before {
	border-bottom: none;
...
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon:hover + .desc:after,
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub .icon + .desc:hover:after {
	border-bottom: none;
...
.user-loginas-panel #page-popup div[role=main] {
	margin: 0;
}
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .subcontent.signup {
	margin: 0 10px 10px 0;
}
.user-loginas-panel #page-popup .loginbox .signuppanel .subcontent-wrapper .guestsub {
       margin: 0 10px 10px 0;
...
.user-loginas-panel #page-popup .loginpanel .loginform-top,
.user-loginas-panel #page-popup .signuppanel .subcontent-wrapper h2 {
    display: none;
}
...
.crw_cs_catblocktitle:before {
	...
	height: 40px;
	vertical-align:top;
	background:url('/theme/image.php/opentechnology/theme/1585138938/btn/btn-crwcat') 50% 50% no-repeat;
	filter: brightness(1) invert(0%);
                    -moz-filter: brightness(100%) invert(0%);
                    -webkit-filter: brightness(100%) invert(0%);
                    -ms-filter: brightness(100%) invert(0%);
...
.clajax_categoryname:before {
	...
	height: 40px;
	vertical-align:top;
	background:url('/theme/image.php/opentechnology/theme/1585138938/btn/btn-crw') 50% 50% no-repeat;
	filter: brightness(1) invert(0%);
                    -moz-filter: brightness(100%) invert(0%);
                    -webkit-filter: brightness(100%) invert(0%);
                    -ms-filter: brightness(100%) invert(0%);
...
.collapsible-section-switcher-slidedown-label .collapsible-section-switcher-label-text::after {
	background-image: url('/theme/image.php/opentechnology/theme/1585138938/collapsiblesection/cs-expand'); 
}

.collapsible-section-switcher-slideup-label .collapsible-section-switcher-label-text::after {
	background-image: url('/theme/image.php/opentechnology/theme/1585138938/collapsiblesection/cs-collapse'); 
}
...
@media (max-width: 768px)
{
	...
	.custom_menu_mobile_label:not(.nomobile):before {
    	...
    	width: 100%;
    	height: 100%;
    	background: url('/theme/image.php/opentechnology/theme/1585138938/mobileicon');
    	content: '';
    	background-size: cover;
	}
	...
	#custommenu_mobile_bg_label:not(.nomobile)::before {
		...
		left: -300%;
		background-color: #FFF;
		background-image: url('/theme/image.php/opentechnology/theme/1585138938/close');
...
@media (max-width: 425px) {
    ...
    .popover-region-header-actions .newmessage-link a {
	    ...
	    font-size: 0;
	    line-height: 0;
	    background: url('/theme/image.php/opentechnology/theme/1585138938/newmessage') center center no-repeat;
	    width: 17px;
	    height: 17px;
	    vertical-align: top;
    }
